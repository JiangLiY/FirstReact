    ...
    return (
      <div>
        <Modal size='small' open={open} onClose={close}>
          ...
          <Modal.Actions>
            <Button positive onClick={this.submit} icon='checkmark'
...
class My extends React.Component {
  constructor(props) {
    ...
    this.state = {
      uname:'',
      avatarPath: '',
      imageOpen: false, // 控制选择图片的弹窗显示
      cropOpen: false,  // 控制图片裁切弹窗显示
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      ...
      avatarPath: ret.data.avatarPath
    })
  }
  // 控制选择图片的弹窗显示
  openImageWindow = () => {
  ...
  render() {
    return (
      <div className='my-container'>   
        ...
        <ImageCropModal updateImage={this.updateImage} avatar={this.state.fileContent} 
          open={this.state.cropOpen} close={this.closeCropWindow}
        />
